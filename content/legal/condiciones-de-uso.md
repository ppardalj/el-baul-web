...
Las presentes Condiciones de Uso regulan el acceso y utilización de El Baúl, un servicio desarrollado por **EXEAL SOLUTIONS, S.L.**, destinado a ayudar a las familias a preservar, compartir y enriquecer su historia mediante fotografías, recuerdos, capítulos y otros contenidos relacionados.
...
Solo podrán crear una cuenta las personas mayores de 14 años.
...
Todos los miembros de un mismo baúl pueden acceder a la totalidad del contenido almacenado en él, salvo que en el futuro se indiquen expresamente otras reglas de acceso.
...
El Custodio es la persona responsable de administrar el baúl y podrá, entre otras acciones:

* invitar o eliminar miembros;
* gestionar las personas incluidas en el baúl;
* moderar el contenido cuando resulte necesario;
* velar por el uso adecuado del baúl conforme a estas condiciones.
...
Al subir fotografías, recuerdos, documentos u otra información, el usuario declara que:

* dispone de los derechos o autorizaciones necesarias para compartir dicho contenido;
* el contenido no vulnera derechos de terceros;
* el contenido cumple la legislación aplicable.
...
No obstante, concede a EXEAL SOLUTIONS, S.L. una licencia no exclusiva, mundial, gratuita y limitada a la prestación del servicio para:

* almacenar los contenidos;
* generar miniaturas y versiones adaptadas;
* realizar copias de seguridad;
* sincronizar el contenido entre dispositivos;
* compartirlo con los miembros autorizados del baúl correspondiente;
* procesarlo mediante funcionalidades de inteligencia artificial cuando el propio usuario las solicite.
...
Los usuarios se comprometen a utilizar el servicio de forma respetuosa y conforme a la legislación vigente.

En particular, no podrá utilizarse para:

* difundir contenido ilícito;
* vulnerar derechos de terceros;
* acosar o amenazar a otras personas;
* difundir malware o software malicioso;
...
Estas funcionalidades constituyen herramientas de apoyo y sus respuestas pueden contener errores o interpretaciones inexactas.
...
No obstante, podrán producirse interrupciones derivadas de:
...
La eliminación de la cuenta no implica necesariamente la eliminación automática de todos los contenidos compartidos dentro de los baúles, ya que estos forman parte de la historia compartida de los demás miembros.
...
* utilización fraudulenta del servicio;
* actividades ilícitas;
* actuaciones que comprometan la seguridad de la plataforma o de otros usuarios.
...
Cualquier controversia que pudiera surgir en relación con la utilización del servicio se someterá a los juzgados y tribunales que resulten competentes conforme a la normativa aplicable.
