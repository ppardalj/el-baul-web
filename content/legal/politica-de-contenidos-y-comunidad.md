---
title: "Política de Contenidos y Comunidad"
layout: single
---
...
No somos una red social ni una plataforma pública de publicación de contenidos. Cada baúl es un espacio privado creado para conservar recuerdos, fotografías e historias entre personas que mantienen una relación familiar o de confianza.
...
En particular, deberás procurar que:

* la información sea veraz o claramente identificable como un recuerdo u opinión personal;
* el contenido se comparta de buena fe;
* no se utilice el servicio para humillar, acosar o perjudicar a otras personas;
* las fotografías y recuerdos se compartan con el respeto que merecen quienes aparecen en ellos.
...
Al incorporar información sobre terceras personas, el usuario declara que dispone de una base legítima para hacerlo y que dicho uso resulta coherente con la finalidad privada y familiar del servicio.
...
Los usuarios deberán actuar siempre teniendo en cuenta el interés superior del menor y evitando compartir contenidos que puedan perjudicarle, exponerle innecesariamente o afectar a su privacidad.
...
* infrinjan derechos de propiedad intelectual o de imagen de terceros;
* promuevan actividades delictivas;
* contengan amenazas o acoso;
* fomenten la violencia o la discriminación;
* incluyan software malicioso o intenten comprometer la seguridad del servicio;
...
Al subir una fotografía, el usuario declara que dispone de los derechos o autorizaciones necesarias para compartirla dentro del baúl correspondiente.
...
La IA puede cometer errores, realizar interpretaciones inexactas o generar respuestas incompletas.
...
Siempre estudiaremos cada caso de forma individual.
...
Cada solicitud será analizada teniendo en cuenta:

* la normativa aplicable;
* los derechos de las personas afectadas;
* el interés legítimo de conservar la historia familiar;
...
* solicitar aclaraciones al usuario;
* ocultar temporalmente un contenido mientras se revisa;
* eliminar contenidos que infrinjan esta política o la legislación vigente;
* limitar determinadas funcionalidades de la cuenta;
* suspender temporalmente el acceso;
* cancelar definitivamente la cuenta en los casos más graves.
...
Siempre que sea posible, recomendamos resolver estas situaciones mediante el diálogo entre los miembros del baúl.

El Custodio dispone de herramientas para administrar el acceso al baúl y moderar los contenidos cuando resulte necesario.
...
Nuestro compromiso es ofrecer un espacio privado, seguro y respetuoso donde esas historias puedan conservarse y transmitirse de generación en generación.

Pedimos a todos los usuarios que utilicen El Baúl con el mismo cuidado con el que tratarían un baúl lleno de recuerdos familiares en su propia casa.
