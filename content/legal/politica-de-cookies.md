...
* recordar preferencias básicas de funcionamiento.
...
Nos ayudan a comprender cómo utilizan los usuarios El Baúl para mejorar el servicio.

Actualmente utilizamos:

| Proveedor         | Finalidad                                                                                                                                             |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Google Analytics  | Obtener estadísticas agregadas de uso del sitio web y la aplicación.                                                                                  |
| Microsoft Clarity | Analizar de forma anonimizada la interacción de los usuarios con la interfaz mediante mapas de calor, grabaciones de sesión y métricas de usabilidad. |
...
Las cookies de analítica únicamente se instalarán cuando el usuario haya otorgado su consentimiento mediante el banner de cookies.
...
* rechazarlas;
* configurar qué categorías deseas permitir.
...
A continuación se incluyen enlaces a la documentación oficial de los principales navegadores:
...
Cuando dichos proveedores realicen transferencias internacionales de datos, estas se efectuarán con las garantías previstas por la normativa aplicable.
...
Cuando los cambios sean relevantes, los comunicaremos a los usuarios mediante los mecanismos habituales del sitio web.
