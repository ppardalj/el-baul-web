...
Nuestro objetivo no es sustituir la memoria humana, sino facilitar que los recuerdos puedan explorarse, enriquecerse y transmitirse entre generaciones.
...
* responder preguntas sobre el contenido de un baúl;
* ayudar a recordar acontecimientos, personas o lugares;
* resumir historias y recuerdos;
* descubrir relaciones entre fotografías, capítulos, personas y recuerdos;
* sugerir información que pueda faltar;
* facilitar la organización del contenido;
* mejorar la búsqueda dentro del baúl.
...
Dependiendo de la consulta realizada, esto podrá incluir:
...
* otra información almacenada en el baúl.
...
La información enviada se utiliza exclusivamente para generar la respuesta solicitada por el usuario.

De acuerdo con las condiciones publicadas por OpenAI para su servicio de API, los datos enviados a través de dicha API no se utilizan para entrenar sus modelos.
...
* cometer errores;
* generar respuestas incompletas;
* interpretar incorrectamente un recuerdo;
* establecer relaciones que no sean correctas;
* omitir información relevante.

Las respuestas generadas no constituyen hechos verificados ni sustituyen la memoria, el criterio o el conocimiento de las personas.
...
Solo procesamos la información necesaria para prestar el servicio solicitado y aplicamos las medidas de seguridad descritas en nuestra Política de Privacidad.
...
Podremos incorporar nuevas funcionalidades, mejorar los modelos utilizados o modificar la forma en que se prestan estos servicios con el objetivo de ofrecer una mejor experiencia a los usuarios.
...
La inteligencia artificial debe servir para ayudar a conservar ese legado, nunca para apropiarse de él.

Por ello diseñamos las funcionalidades de IA de El Baúl siguiendo cuatro principios:

* **Privacidad por defecto:** la información permanece dentro del ámbito privado de cada baúl y solo se procesa cuando es necesario para prestar el servicio.
* **Transparencia:** explicamos de forma clara cuándo interviene la inteligencia artificial y qué información utiliza.
* **Control del usuario:** las funcionalidades de IA están al servicio de las personas y no sustituyen sus decisiones.
* **Respeto por la memoria familiar:** la IA puede ayudar a descubrir conexiones y facilitar recuerdos, pero la historia de cada familia siempre pertenece a quienes la vivieron.
